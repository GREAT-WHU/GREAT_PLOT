...
if __name__ == '__main__':
    ...
    #main(118.055917, 24.559724, 118.244753, 24.399450, 12, r'google.tif', server="google")
    #main(99.1, 38, 101.2, 36.8, 12, r'google_satn.tif', server="google_sat")
    main(96.5, 40, 103, 34.5, 10, r'google_sat3.tif', server="google_sat")
    #main(99.1, 36.79, 101.2, 35.75, 12, r'google_sat.tif', server="google_sat")
    #main(118.055917, 24.559724, 118.244753, 24.399450, 12, r'amap.tif', server="amap")
    #main(118.055917, 24.559724, 118.244753, 24.399450, 16, r'amap_sat.tif', server="amap_sat")
